<xsl:stylesheet version="2.0"
 ...
 xmlns:fhir="http://hl7.org/fhir">
    ...
    <xsl:param name="vs2" select="'../templates/2.16.756.5.30.1.127.3.10.1.27.xml'" />
    <xsl:param name="doc2" select="document($vs2)" />
    <xsl:param name="vs3" select="'../templates/2.16.756.5.30.1.127.3.10.1.5.xml'" />
    <xsl:param name="doc3" select="document($vs3)" />
    <xsl:param name="vs4" select="'../templates/2.16.756.5.30.1.127.3.10.1.13.xml'" />
    <xsl:param name="doc4" select="document($vs4)" />
    ...
    <xsl:variable name="codes4" select="$doc4/fhir:ValueSet/fhir:compose/fhir:include[fhir:system[@value=$system]]/fhir:concept" />
   ...
   <xsl:template match="fhir:ValueSet/fhir:name">
    ...
    <xsl:template match="fhir:ValueSet/fhir:compose">
      <xsl:apply-templates select="$codes" /> 
       ...
       <xsl:apply-templates select="$codes4" /> 
    </xsl:template>
